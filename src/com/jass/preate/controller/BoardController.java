...
public class BoardController {
	...
	public String developerBoard(Model model) {
		...
		List<Board> list = boardDao.getBoards(1, "개발자");
	...
	public String freeBoard(Model model) {
		...
		List<Board> list = boardDao.getBoards(1, "자유");
