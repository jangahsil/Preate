...
<head>
	<link href="${ctxName}/resource/css/board/designer-style.css" rel="stylesheet"	type="text/css" />
</head>
<body>
	<main id="main">
		<section>
			...
			<nav id="category">
				...
				<ul class="clearfix">
					<li><a href="designerBoard" class="button all-button">전체보기</a></li>
					<li><a href="designerBoard?category=theory" class="button theory-button">이론</a></li>
					<li><a href="designerBoard?category=tool" class="button tool-button">툴</a></li>
					<li><a href="designerBoard?category=tip" class="button tip-button">팁/강좌</a></li>
					<li><a href="designerBoard?category=qna" class="button qna-button">질문/답변</a></li>
				</ul>
			</nav>
			...
			<section id="board-search">
				...
				<c:if test="${category != null}">
				<form action="designerBoard?category=${category}" method="post">
				</c:if>
					<fieldset>
