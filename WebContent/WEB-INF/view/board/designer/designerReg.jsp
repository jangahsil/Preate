			...
			<section id="main-content">
				...
				<section id="board">
					...
					<form method="post" enctype="multipart/form-data">
						...
						<div>
							<input type="submit" class="button btn-write" name="btn" value="작성" /><a href="designerBoard"></a>
							<input type="submit" class="button btn-cancel" name="btn" value="취소" /><a href="designerBoard"></a>
						</div>
					</form>
				</section>
			</section>
